...
json_path = './Fight_val2_20181010.json'
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        ori = 0
        # for i in range(1, 6):
        val_dir = '/home/fs168/dataSet/BOT新零售技术赛测试集2'
        ...
        for file_name in file_list:
            ...
            if "scene_1" in file_name:
                image_id = "id_" + str(id_num)
            elif "scene_2" in file_name:
                image_id = "id_" + str(id_num + 3520)
            elif "scene_3" in file_name:
                image_id = "id_" + str(id_num + 5265)
            elif "scene_4" in file_name:
